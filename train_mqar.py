...
def train(lambda_mode, model_dim, num_kv_pairs, seq_len, batch_size,
          max_steps, lr, mlp_hidden_dim, seed, device, test_seq_len=None, output_dir="results/mqar"):
    ...
    # output dir for this specific run
    ...
    print(f"\n{'='*60}")
    print(f"Mode: {lambda_mode} | dim: {model_dim} | kv: {num_kv_pairs} | seq: {seq_len} | seed: {seed}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir",     type=str,   default="results/mqar")
